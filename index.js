async function retrieveInfo(){
    const prom = fetch('https://cdn.contentful.com/spaces/c7mvxwqo377u/environments/master/entries?access_token=E-RDKeYnP6fPL12njEjE-P2mHwG0f1DQLfP2Ey7cgyY')
    ...
    .then((data)=> {
        ...
        for(let e of data.items){
            ...
            fetch('https://cdn.contentful.com/spaces/c7mvxwqo377u/environments/master/assets?access_token=E-RDKeYnP6fPL12njEjE-P2mHwG0f1DQLfP2Ey7cgyY')
